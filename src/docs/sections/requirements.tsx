import { Callout, Code, Means, P, Routes, Scope, Snippet, Sub, V1, VerdictBadge } from "../parts";
 ...
 */
export const requirements: DocSection = {
  id: "requirements",
  title: "Operation requirements",
  lede: (
    <>
      Requirements are proof obligations. Declaring one asserts nothing about the operation; it asks the checker
      to establish the property from the model&apos;s facts and structure. A requirement the checker cannot
      establish is reported <VerdictBadge verdict="unknown" />, which is a statement about the proof, not about
      the architecture.
    </>
  ),
  items: [
